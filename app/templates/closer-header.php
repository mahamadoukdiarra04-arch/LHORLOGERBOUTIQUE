...
<head>
  ...
  <link rel="stylesheet" href="<?= e(url('/assets/css/closer.css')) ?>?v=20260906-whatsapp-delivery">
  <script src="<?= e(url('/assets/js/closer.js')) ?>?v=20260906-whatsapp-delivery" defer></script>
</head>
