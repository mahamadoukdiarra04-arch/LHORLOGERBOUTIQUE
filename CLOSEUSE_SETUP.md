...
Sur iPhone, le bouton de partage ouvre le menu natif avec la fiche illustrée et le texte prérempli. Une fois le partage terminé, la commande passe en **En livraison** et quitte le suivi actif. Sur un appareil qui ne sait pas joindre automatiquement l’image, la closeuse ouvre WhatsApp en texte puis confirme l’envoi dans l’espace de suivi.

L’envoi WhatsApp reste une action explicite de la closeuse. Un envoi entièrement automatique, sans validation humaine, demanderait un compte et une API WhatsApp Business.
